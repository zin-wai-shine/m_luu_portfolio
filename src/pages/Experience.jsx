      ...
      <section className="relative py-20 px-4 overflow-hidden bg-black">
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            >
              8 years of experience across various production roles in the filmmaking industry
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="space-y-8">
              {awards.map((award, index) => (
                ...
                >
                  <Card className="p-6 lg:p-8 border-l-4 border-l-deep-yellow">
                    <div className="flex flex-col md:flex-row md:items-start gap-6">
                      <div className="text-6xl flex-shrink-0">{award.icon}</div>
                      <div className="flex-1 space-y-4">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                          ...
                          {award.year && (
                            <span 
                              className="text-deep-yellow font-light text-xl md:text-2xl"
                              style={{
