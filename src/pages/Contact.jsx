      ...
      <section className="relative py-20 px-4 overflow-hidden bg-black">
        <div className="container mx-auto max-w-7xl lg:max-w-full relative z-10">
          ...
          >
            ...
            >
              <span style={{ color: '#FFFFFF', textShadow: '0 0 30px rgba(255, 255, 255, 0.2)' }}>Get in</span> <br />
              <span 
                style={{
                        ...
                        <div className="flex-1">
                          ...
                          {info.link ? (
                            <a
                              href={info.link}
                              style={{ color: '#FFFFFF' }}
                              className="text-base font-medium hover:text-red-400 transition-colors break-all"
                            >
                              {info.value}
                            </a>
                          ) : (
